...
| :-------------------------------------------: | :-----------------------------------: | :----------------------------------------: |
| ![Скриншот приложения](steps/main_screen.png) | ![Скриншот приложения](steps/win.png) | ![Скриншот приложения](steps/no_coins.png) |
...
**Зламанюк А.А.; Телятникова Е.П.** — группа ИСП-231
